...
public class Compound extends JFrame {
	...
	private class CalculateAction implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (InputBox3.getText().equals("") && InputBox1.getText() != null
				...
				InputBox3.setText(""
						+ (float) (Math.round((money * sum) * 100)) / 100);
			...
			// 算年限
			else if (InputBox2.getText().equals("")
					&& InputBox1.getText() != null
					&& InputBox4.getText() != null
			...
			// 算利率
			else if (InputBox4.getText().equals("")
					&& InputBox1.getText() != null
					&& InputBox2.getText() != null
					&& InputBox3.getText() != null) {
